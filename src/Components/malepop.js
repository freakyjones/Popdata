...
class Malepop extends Component{
  constructor(props){
    super(props)
    this.state={
      display:"Bar",
         ...
         <DataContext.Consumer>
           {
             (context)=>{
              const Theme=context.islight?context.Theme.light:context.Theme.dark;
               return(
                <section id="malepop" style={{background:`${ Theme.ui_background}`,marginTop:'0px'}}>
                              ...
                              <Showcase handlechange={this.handlechange} display={this.state.display}/>
                                    <div className="axis">
                                         <div className="x row">
                                             <p>x-axis</p>
                                           <div className="line">
                                              <p style={{color:`${Theme.axis_content}`}}>population</p>
                                           </div>
                                         </div>
                                         <div className="y row">
                                             <p>x-axis</p>
